        ...
        IConfigurationOfService
    {
            ...
            IServiceCollection services)
        {
            ...
            {   
                ...
                x.AddRequestClient<ICreateCashOutputRequestContract>(new Uri($"{ContractBase.RabbitMqLocation}/ICreateCashOutputRequestContract")); 
                x.AddRequestClient<ICreateCashInputRequestContract>(new Uri($"{ContractBase.RabbitMqLocation}/ICreateCashInputRequestContract"));
            });
