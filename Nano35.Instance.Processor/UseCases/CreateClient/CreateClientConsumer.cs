...
{
    public class CreateClientConsumer : IConsumer<ICreateClientRequestContract>
    {
        ...
        public async Task Consume(ConsumeContext<ICreateClientRequestContract> context)
        {
            ...
            var result = 
                await new LoggedUseCasePipeNode<ICreateClientRequestContract, ICreateClientSuccessResultContract>(
                    _services.GetService(typeof(ILogger<ICreateClientRequestContract>)) as ILogger<ICreateClientRequestContract>,
                    new TransactedUseCasePipeNode<ICreateClientRequestContract, ICreateClientSuccessResultContract>(dbContext, new CreateClientUseCase(dbContext)))
