...
{
    public class TransactedCreateUnitRequest :
        PipeNodeBase<
            ...
            ICreateUnitResultContract>
    {
        ...
        public TransactedCreateUnitRequest(ApplicationContext context,
            IPipeNode<ICreateUnitRequestContract, ICreateUnitResultContract> next) : base(next)
        {
            _context = context;
        }
