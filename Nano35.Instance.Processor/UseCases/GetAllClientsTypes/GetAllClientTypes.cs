...
{
    public class GetAllClientTypes : EndPointNodeBase<IGetAllClientTypesRequestContract, IGetAllClientTypesResultContract>
    {
        private readonly ApplicationContext _context;
        public GetAllClientTypes(ApplicationContext context) => _context = context;
