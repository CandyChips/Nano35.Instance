...
{
    public class GetAllInstanceTypes : EndPointNodeBase<IGetAllInstanceTypesRequestContract, IGetAllInstanceTypesResultContract>
    {
        private readonly ApplicationContext _context;
        public GetAllInstanceTypes(ApplicationContext context) => _context = context;
