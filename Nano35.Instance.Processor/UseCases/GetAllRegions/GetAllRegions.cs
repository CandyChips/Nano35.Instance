...
{
    public class GetAllRegions : EndPointNodeBase<IGetAllRegionsRequestContract, IGetAllRegionsResultContract>
    {
        private readonly ApplicationContext _context;
        public GetAllRegions(ApplicationContext context) => _context = context;
