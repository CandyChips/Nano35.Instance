...
namespace Nano35.Instance.Processor.UseCases.GetAllRoles
{
            ...
            IGetAllRolesResultContract>
    {
        ...
        public LoggedGetAllRolesRequest(ILogger<LoggedGetAllRolesRequest> logger,
            IPipeNode<IGetAllRolesRequestContract, IGetAllRolesResultContract> next) : base(next)
        {
            _logger = logger;
        }
