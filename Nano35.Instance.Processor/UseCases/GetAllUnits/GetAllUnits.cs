...
{
    public class GetAllUnits : EndPointNodeBase<IGetAllUnitsRequestContract, IGetAllUnitsResultContract>
    {
        private readonly ApplicationContext _context;
        private readonly IBus _bus;
        public GetAllUnits(ApplicationContext context, IBus bus) { _context = context; _bus = bus; }
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                var response = await new MasstransitRequest<IGetCashboxByUnitIdRequestContract, IGetCashboxByUnitIdResultContract>(
                    _bus, 
