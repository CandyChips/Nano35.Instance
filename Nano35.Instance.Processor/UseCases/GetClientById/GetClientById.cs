...
{
    public class GetClientById : EndPointNodeBase<IGetClientByIdRequestContract,IGetClientByIdResultContract>
    {
        private readonly ApplicationContext _context;
        public GetClientById(ApplicationContext context) => _context = context;
