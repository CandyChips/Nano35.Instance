...
{
    public class GetInstanceById : EndPointNodeBase<IGetInstanceByIdRequestContract, IGetInstanceByIdResultContract>
    {
        private readonly ApplicationContext _context;
        public GetInstanceById(ApplicationContext context) => _context = context;
