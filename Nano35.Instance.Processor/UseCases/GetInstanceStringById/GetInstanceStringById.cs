...
{
    public class GetInstanceStringById : EndPointNodeBase<IGetInstanceStringByIdRequestContract, IGetInstanceStringByIdResultContract>
    {
        private readonly ApplicationContext _context;
        public GetInstanceStringById(ApplicationContext context) => _context = context;
