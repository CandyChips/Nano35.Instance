...
namespace Nano35.Instance.Processor.UseCases.GetInstanceStringsByIds
{
    public class GetInstanceStringsByIdsConsumer : IConsumer<IGetInstanceStringsByIdsRequestContract>
    {
        ...
        {
            var result =
                await new LoggedPipeNode<IGetInstanceStringsByIdsRequestContract, IGetInstanceStringsByIdsResultContract>(
                    ...
                    new GetInstanceStringsByIds(_services.GetService(typeof(ApplicationContext)) as ApplicationContext))
