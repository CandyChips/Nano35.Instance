...
{
    public class GetUnitById : EndPointNodeBase<IGetUnitByIdRequestContract, IGetUnitByIdResultContract>
    {
        private readonly ApplicationContext _context;
        public GetUnitById(ApplicationContext context) => _context = context;
