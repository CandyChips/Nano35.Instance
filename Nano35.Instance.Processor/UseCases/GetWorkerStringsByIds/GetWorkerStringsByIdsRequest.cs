...
{
    public class GetWorkerStringsByIdsRequest :
        IPipelineNode<IGetWorkerStringsByIdsRequestContract, IGetWorkerStringsByIdsResultContract>
    {
        private readonly ApplicationContext _context;

        public GetWorkerStringsByIdsRequest(ApplicationContext context)
        {
            _context = context;
        }
