...
{
    public class UpdateClientsEmail : EndPointNodeBase<IUpdateClientsEmailRequestContract, IUpdateClientsEmailResultContract>
    {
        private readonly ApplicationContext _context;
        public UpdateClientsEmail(ApplicationContext context) => _context = context;
