...
{
    public class UpdateClientsName : EndPointNodeBase<IUpdateClientsNameRequestContract, IUpdateClientsNameResultContract>
    {
        private readonly ApplicationContext _context;
        public UpdateClientsName(ApplicationContext context) => _context = context;
