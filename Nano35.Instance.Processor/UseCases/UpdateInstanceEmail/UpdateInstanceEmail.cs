...
{
    public class UpdateInstanceEmail : EndPointNodeBase<IUpdateInstanceEmailRequestContract, IUpdateInstanceEmailResultContract>
    {
        private readonly ApplicationContext _context;
        public UpdateInstanceEmail(ApplicationContext context) => _context = context;
