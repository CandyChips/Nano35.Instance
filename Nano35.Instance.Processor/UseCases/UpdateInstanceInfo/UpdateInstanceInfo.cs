...
{
    public class UpdateInstanceInfo : EndPointNodeBase<IUpdateInstanceInfoRequestContract, IUpdateInstanceInfoResultContract>
    {
        private readonly ApplicationContext _context;
        public UpdateInstanceInfo(ApplicationContext context) => _context = context;
