...
{
    public class UpdateInstanceName : EndPointNodeBase<IUpdateInstanceNameRequestContract, IUpdateInstanceNameResultContract>
    {
        private readonly ApplicationContext _context;
        public UpdateInstanceName(ApplicationContext context) => _context = context;
