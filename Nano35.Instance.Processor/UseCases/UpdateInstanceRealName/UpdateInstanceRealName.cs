...
{
    public class UpdateInstanceRealName : EndPointNodeBase<IUpdateInstanceRealNameRequestContract, IUpdateInstanceRealNameResultContract>
    {
        private readonly ApplicationContext _context;
        public UpdateInstanceRealName(ApplicationContext context) => _context = context;
