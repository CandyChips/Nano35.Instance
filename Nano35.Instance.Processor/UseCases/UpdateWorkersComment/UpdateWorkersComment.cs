...
{
    public class UpdateWorkersComment : EndPointNodeBase<IUpdateWorkersCommentRequestContract, IUpdateWorkersCommentResultContract>
    {
        private readonly ApplicationContext _context;
        public UpdateWorkersComment(ApplicationContext context) => _context = context;
