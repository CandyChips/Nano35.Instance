...
{
    public class UpdateWorkersName : EndPointNodeBase<IUpdateWorkersNameRequestContract, IUpdateWorkersNameResultContract>
    {
        private readonly ApplicationContext _context;
        public UpdateWorkersName(ApplicationContext context) => _context = context;
